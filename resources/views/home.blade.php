        ...
        <section class="col-lg-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Kualifikasi lulusan diuraikan dalam bentuk narasi deskriptif yang menyatakan capaian pembelajaran
                ...
                <div class="card-body">
                    <ol style="text-align:justify;margin-left:-20px;">
                        <li>Merupakan dokumen tambahan yang menyatakan kemampuan kerja, penguasaan pengetahuan, dan
                            sikap/moral seorang lulusan yang lebih mudah dimengerti oleh pihak pengguna di dalam maupun luar
                ...
                <div class="card-body">
                    ...
                    <ol style="text-align:justify;margin-left:-15px;">
                        ...
                        <li>
                            ...
                            dengan mengklik tombol <b>Ubah</b> untuk mengaktifkan formulir profil. Kemudian ketiklah data
                        ...
                        <li>
                            Setelah membuka file foto yang digunakan, klik tombol <b>upload</b>. Jika upload anda berhasil
                            maka foto profl anda akan langsung terganti. Namun, jika gagal, maka file yang anda upload
                            <b>bukan file format jpg atau jpeg</b> atau <b>ukuran file foto melebihi batas maksimal, yaitu
                                500KB</b>.
                        </li>
                        <li>
                            Jika profil anda telah lengkap, langkah selanjutnya adalah mengisi data sertifikat yang anda.
                            Data sertifikat yang digunakan dalam SKPI dibagi berdasarkan 4 (empat) kategori, yaitu <b>Kerja
                        ...
                        <li>
                            Kemudian isi data sertifikat anda dengan benar dan pilih file sertifikat yang telah anda scan
                            dengan mengklik tombol <b>Pilih File</b>, lalu klik tombol <b>Simpan</b> untuk menyimpan data
                            sertifikat dan klik tombol <b>Batal</b> untuk membatalkan penyimpanan data.</li>
                        <li>Jika penyimpanan data sertifikat gagal, berarti data yang anda masukkan belum lengkap atau file
                            scan sertifikat yang anda upload <b>bukan format pdf</b> dan <b>ukuran file pdf yang diupload
                        ...
                        <li>
                            ...
                            klik <b>Simpan</b> untuk menyimpan perubahan data sertifikat dan klik tombol <b>Batal</b> untuk
                            membatalkan perubahan data.
                        </li>
                        <li>
                            Jika anda ingin menghapus data sertifkat, <b>klik kotak cek (<i>Check Box</i>)</b> pada baris
                            data sertifikat yang ingin anda hapus. Setelah itu klik tombol hapus, makan akan muncul kotak
                        ...
                        <li>
                            Jika anda ingin mendownload file sertifikat yang sudah anda upload, klik teks <b>Download</b>
                            yang ada di dalam tabel.
                        </li>
                        <li>
                            Jika anda ingin mengetahui status data <b>Surat Keterangan Pendamping Ijazah (SKPI)</b> anda,
