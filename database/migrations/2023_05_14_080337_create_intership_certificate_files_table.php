...
return new class extends Migration
{
    ...
    {
        Schema::create('intership_certificate_files', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('internship_period')->comment('Lama Magang');
    ...
    {
        Schema::dropIfExists('intership_certificate_files');
    }
};
